      ...
      <footer role="contentinfo" style="padding: var(--r-space-12) var(--r-space-6); text-align: center; border-top: 1px solid rgba(255, 255, 255, 0.1);">
        <div class="ds-container">
          ...
          <nav aria-label="Footer navigation" style="display: flex; justify-content: center; gap: var(--r-space-6); margin-bottom: var(--r-space-6); flex-wrap: wrap;">
            ...
            <a href="/storybook/" data-i18n-title="nav.storybook" style="color: hsl(var(--foreground) / 0.7); text-decoration: none; transition: color var(--r-transition-fast);"><span data-i18n="footer.nav.storybook">Storybook</span></a>
...
const DEFAULT_TRANSLATIONS = {
  en: {
    ...
    'index.stats.agents': 'Agent Ready',
    'index.ai.label': 'AI-Ready',
    'index.ai.heading': 'The old workflow is over.<br>Agents build on primitives.',
    'index.ai.body': 'Designers pushing pixels and developers hand-rolling CSS was the last era. The next one is you describing the product — and AI composing interfaces from a design system it can actually read. Rukn is structured for that: semantic tokens, documented components, zero hidden magic.',
    'index.ai.step1.status': 'Step 1',
    'index.ai.step1.title': 'Describe',
    'index.ai.step1.body': 'Tell your agent what you\'re building — in English, Arabic, or Urdu. A checkout flow, admin panel, landing page. No Figma file required.',
    'index.ai.step2.status': 'Step 2',
    'index.ai.step2.title': 'Compose',
    'index.ai.step2.body': 'The agent reads Rukn\'s tokens, class names, and Web Components — then assembles production markup. <code>btn-primary</code>, <code>ds-card</code>, <code>rukn-navbar</code>. Predictable. Copy-pasteable. Correct.',
    'index.ai.step3.status': 'Step 3',
    'index.ai.step3.title': 'Ship',
    'index.ai.step3.body': 'You review, refine, and deploy. Build on top of the primitives — extend tokens, wrap components, own the stack. MIT licensed. Zero dependencies.',
    'index.why.label': 'Why Rukn',
    'index.why.heading': 'Primitives agents understand.<br>Interfaces humans love.',
    'index.why.ai.title': 'AI-Ready Architecture',
    'index.why.ai.body': 'Structured docs, semantic tokens, and consistent APIs — built so Cursor, Claude, Copilot, and any agent can read the system and generate correct UI the first time.',
    'index.why.glass.title': 'Glass Morphism',
    'index.why.glass.body': 'Frosted glass surfaces and translucent depth — premium UI out of the box, no custom CSS from your agent.',
    'index.why.tokens.title': '150+ Tokens',
    'index.why.tokens.body': 'W3C-compliant design tokens covering color, spacing, typography, shadows, and motion.',
    'index.why.rtl.title': 'RTL First',
    'index.why.rtl.body': 'Arabic and Urdu layouts that just work. <code>dir="rtl"</code> flips everything — no patches needed.',
    'index.why.theme.title': 'Dark & Light',
    'index.why.theme.body': 'Toggle themes with a single class. Tokens adapt automatically.',
    'index.components.label': 'Components',
    'index.components.heading': 'Primitives your agent<br>can copy and ship.',
    'index.components.buttons.title': 'Buttons',
    'index.components.buttons.body': 'Seven variants, three sizes, loading states, and icon support. Accessible focus rings included.',
    'index.components.forms.title': 'Form Controls',
    'index.components.forms.body': 'Inputs, checkboxes, radio buttons, toggles, sliders — all with glass morphism styling and spring animations.',
    'index.components.cards.title': 'Cards & Badges',
    'index.components.cards.body': 'Surface components with hover states, glass variants, and semantic badge colors for status indicators.',
    'index.components.viewDocs': 'View docs',
    'index.components.viewAll': 'View All Components',
    'index.demo.primary': 'Primary',
    'index.demo.secondary': 'Secondary',
    'index.demo.outline': 'Outline',
    'index.demo.ghost': 'Ghost',
    'index.demo.delete': 'Delete',
    'index.demo.email': 'Email address',
    'index.demo.checkbox': 'Checkbox',
    'index.demo.toggle': 'Toggle',
    'index.demo.glassCard.title': 'Glass Card',
    'index.demo.glassCard.body': 'Beautiful surface component with subtle depth.',
    'index.demo.success': 'Success',
    'index.demo.warning': 'Warning',
    'index.demo.neutral': 'Neutral',
    'index.install.label': 'For agents & humans',
    'index.install.heading': 'Point your AI here.<br>Build on Rukn.',
    'index.install.body': 'Drop two tags into your <code style="font-size:0.85em; color:hsl(var(--primary));">&lt;head&gt;</code>, point your agent at this repo, and describe what you need. Tokens, components, and docs are structured for machine-readable composition — and human review.',
    'index.install.cssSize': '156 KB CSS',
    'index.install.jsSize': '82 KB JS',
    'index.install.zeroDeps': 'Zero dependencies',
    'index.install.explore': 'Explore Components',
    'index.install.tokens': 'Design Tokens',
    'index.install.agentGuide': 'Agent Guide (DESIGN.md)',
    ...
    'index.roadmap.label': 'Roadmap',
    'index.roadmap.heading': 'What\'s next.',
    'index.roadmap.shipped': 'Shipped',
    'index.roadmap.progress': 'In Progress',
    'index.roadmap.planned': 'Planned',
    'index.roadmap.shipped.glass': 'Glass morphism system',
    'index.roadmap.shipped.tokens': '150+ design tokens',
    'index.roadmap.shipped.webcomponents': 'Web Components library',
    'index.roadmap.shipped.motion': 'Rukn Motion easing',
    ...
    'index.roadmap.progress.vscode': 'VS Code extension',
    'index.roadmap.planned.mcp': 'MCP server for component lookup',
    'index.roadmap.planned.tailwind': 'Tailwind CSS plugin',
    'index.roadmap.planned.cli': 'CLI scaffolding tool',
    'index.roadmap.planned.viz': 'Data visualization',
    'index.roadmap.planned.themes': 'Community themes',
    'index.about.label': 'Open Source',
    'index.about.heading': 'Free forever.<br>No strings attached.',
    'index.about.body': '<strong style="color:hsl(var(--foreground)/0.8);">Rukn</strong> <span class="arabic-text" style="color:hsl(var(--primary));">رُكن</span> means "pillar" in Arabic — the foundation AI agents and developers build on. Structured primitives, MIT licensed, free for commercial use.',
    'index.about.mit.title': 'MIT Licensed',
    'index.about.mit.body': 'Use commercially. Modify freely. No attribution required.',
    'index.about.ai.title': 'AI-Ready',
    'index.about.ai.body': 'Structured primitives agents read. Humans review and ship.',
    'index.about.privacy.title': 'No Tracking',
    'index.about.privacy.body': 'No analytics, no telemetry, no paywalls. Ever.',
    'index.about.star': 'Star on GitHub',
    'index.about.discussions': 'Discussions',
    'index.about.connect': 'Connect',
    'index.cta.heading': 'Describe it.<br>Ship it.',
    'index.cta.body': 'Talk to your AI. Build on Rukn primitives. RTL, glass morphism, and 20+ components — ready when you are.',
    'index.cta.explore': 'Explore Components',
    'index.cta.github': 'View on GitHub',
    'index.cta.meta': 'MIT Licensed · Zero Dependencies · Open Source Forever',
  ...
  ar: {
    ...
    'index.stats.agents': 'جاهز للوكلاء',
    'index.ai.label': 'جاهز للذكاء الاصطناعي',
    'index.ai.heading': 'انتهى أسلوب العمل القديم.<br>الوكلاء يبنون على الأساسيات.',
    'index.ai.body': 'المصممون يحرّكون البكسلات والمطوّرون يكتبون CSS يدوياً — تلك كانت الحقبة السابقة. الحقبة التالية أن تصف المنتج — والذكاء الاصطناعي يركّب الواجهات من نظام تصميم يفهمه فعلياً. رُكن مبني لهذا: رموز دلالية، مكوّنات موثّقة، بلا سحر مخفي.',
    'index.ai.step1.status': 'الخطوة 1',
    'index.ai.step1.title': 'صف',
    'index.ai.step1.body': 'أخبر وكيلك بما تبنيه — بالإنجليزية أو العربية أو الأردية. تدفق دفع، لوحة إدارة، صفحة هبوط. لا حاجة لملف Figma.',
    'index.ai.step2.status': 'الخطوة 2',
    'index.ai.step2.title': 'ركّب',
    'index.ai.step2.body': 'يقرأ الوكيل رموز رُكن وأسماء الفئات ومكوّنات الويب — ثم يبني ترميزاً جاهزاً للإنتاج. <code>btn-primary</code>، <code>ds-card</code>، <code>rukn-navbar</code>. متوقع. قابل للنسخ. صحيح.',
    'index.ai.step3.status': 'الخطوة 3',
    'index.ai.step3.title': 'أطلق',
    'index.ai.step3.body': 'تراجع وتُحسّن وتنشر. ابنِ فوق الأساسيات — وسّع الرموز، غلّف المكوّنات، وامتلك المكدس. ترخيص MIT. بلا تبعيات.',
    'index.why.label': 'لماذا رُكن',
    'index.why.heading': 'أساسيات يفهمها الوكلاء.<br>واجهات يحبها البشر.',
    'index.why.ai.title': 'بنية جاهزة للذكاء الاصطناعي',
    'index.why.ai.body': 'وثائق منظمة ورموز دلالية وواجهات برمجة متسقة — حتى يقرأ Cursor وClaude وCopilot وأي وكيل النظام ويولّد واجهة صحيحة من المرة الأولى.',
    'index.why.glass.title': 'زجاج مورفي',
    'index.why.glass.body': 'أسطح زجاجية ضبابية وعمق شفاف — واجهة فاخرة جاهزة دون CSS مخصص من وكيلك.',
    'index.why.tokens.title': 'أكثر من 150 رمزاً',
    'index.why.tokens.body': 'رموز تصميم متوافقة مع W3C للألوان والمسافات والطباعة والظلال والحركة.',
    'index.why.rtl.title': 'RTL أولاً',
    'index.why.rtl.body': 'تخطيطات عربية وأردية تعمل فوراً. <code>dir="rtl"</code> يقلب كل شيء — بلا ترقيعات.',
    'index.why.theme.title': 'داكن وفاتح',
    'index.why.theme.body': 'بدّل الثيم بفئة واحدة. الرموز تتكيّف تلقائياً.',
    'index.components.label': 'المكوّنات',
    'index.components.heading': 'أساسيات ينسخها وكيلك<br>ويطلقها.',
    'index.components.buttons.title': 'الأزرار',
    'index.components.buttons.body': 'سبعة أنماط، ثلاثة أحجام، حالات تحميل، ودعم أيقونات. حلقات تركيز سهلة الوصول.',
    'index.components.forms.title': 'عناصر النماذج',
    'index.components.forms.body': 'حقول، مربعات اختيار، أزرار راديو، مفاتيح، منزلقات — كلها بزجاج مورفي وحركات سلسة.',
    'index.components.cards.title': 'البطاقات والشارات',
    'index.components.cards.body': 'مكوّنات سطحية بحالات تمرير ومتغيرات زجاجية وألوان شارات دلالية للحالة.',
    'index.components.viewDocs': 'عرض التوثيق',
    'index.components.viewAll': 'عرض كل المكوّنات',
    'index.demo.primary': 'أساسي',
    'index.demo.secondary': 'ثانوي',
    'index.demo.outline': 'محدد',
    'index.demo.ghost': 'شفاف',
    'index.demo.delete': 'حذف',
    'index.demo.email': 'البريد الإلكتروني',
    'index.demo.checkbox': 'مربع اختيار',
    'index.demo.toggle': 'تبديل',
    'index.demo.glassCard.title': 'بطاقة زجاجية',
    'index.demo.glassCard.body': 'مكوّن سطحي جميل بعمق خفيف.',
    'index.demo.success': 'نجاح',
    'index.demo.warning': 'تحذير',
    'index.demo.neutral': 'محايد',
    'index.install.label': 'للوكلاء والبشر',
    'index.install.heading': 'وجّه ذكاءك الاصطناعي هنا.<br>ابنِ على رُكن.',
    'index.install.body': 'أضف وسمين في <code style="font-size:0.85em; color:hsl(var(--primary));">&lt;head&gt;</code>، ووجّه وكيلك إلى هذا المستودع، وصف ما تحتاجه. الرموز والمكوّنات والوثائق مُنظَّمة للتركيب القابل للقراءة آلياً — وللمراجعة البشرية.',
    'index.install.cssSize': '156 ك.ب CSS',
    'index.install.jsSize': '82 ك.ب JS',
    'index.install.zeroDeps': 'بلا تبعيات',
    'index.install.explore': 'استكشف المكوّنات',
    'index.install.tokens': 'رموز التصميم',
    'index.install.agentGuide': 'دليل الوكلاء (DESIGN.md)',
    ...
    'index.roadmap.label': 'خارطة الطريق',
    'index.roadmap.heading': 'ماذا بعد.',
    'index.roadmap.shipped': 'مُنجَز',
    'index.roadmap.progress': 'قيد التنفيذ',
    'index.roadmap.planned': 'مخطط',
    'index.roadmap.shipped.glass': 'نظام الزجاج المورفي',
    'index.roadmap.shipped.tokens': 'أكثر من 150 رمز تصميم',
    'index.roadmap.shipped.webcomponents': 'مكتبة مكوّنات الويب',
    'index.roadmap.shipped.motion': 'منحنيات حركة رُكن',
    ...
    'index.roadmap.progress.vscode': 'إضافة VS Code',
    'index.roadmap.planned.mcp': 'خادم MCP للبحث عن المكوّنات',
    'index.roadmap.planned.tailwind': 'إضافة Tailwind CSS',
    'index.roadmap.planned.cli': 'أداة سقالة CLI',
    'index.roadmap.planned.viz': 'تصور البيانات',
    'index.roadmap.planned.themes': 'ثيمات المجتمع',
    'index.about.label': 'مفتوح المصدر',
    'index.about.heading': 'مجاني إلى الأبد.<br>بلا قيود.',
    'index.about.body': '<strong style="color:hsl(var(--foreground)/0.8);">رُكن</strong> <span class="arabic-text" style="color:hsl(var(--primary));">رُكن</span> يعني "العمود" بالعربية — الأساس الذي يبني عليه وكلاء الذكاء الاصطناعي والمطوّرون. أساسيات منظمة، ترخيص MIT، مجاني للاستخدام التجاري.',
    'index.about.mit.title': 'ترخيص MIT',
    'index.about.mit.body': 'استخدم تجارياً. عدّل بحرية. لا يلزم الإسناد.',
    'index.about.ai.title': 'جاهز للذكاء الاصطناعي',
    'index.about.ai.body': 'أساسيات منظمة يقرأها الوكلاء. البشر يراجعون ويطلقون.',
    'index.about.privacy.title': 'بلا تتبع',
    'index.about.privacy.body': 'بلا تحليلات، بلا قياس عن بُعد، بلا جدران دفع. أبداً.',
    'index.about.star': 'نجّم على GitHub',
    'index.about.discussions': 'النقاشات',
    'index.about.connect': 'تواصل',
    'index.cta.heading': 'صفه.<br>أطلقه.',
    'index.cta.body': 'تحدث إلى ذكائك الاصطناعي. ابنِ على أساسيات رُكن. RTL وزجاج مورفي وأكثر من 20 مكوّناً — جاهزة متى كنت.',
    'index.cta.explore': 'استكشف المكوّنات',
    'index.cta.github': 'عرض على GitHub',
    'index.cta.meta': 'ترخيص MIT · بلا تبعيات · مفتوح المصدر إلى الأبد',
  ...
  ur: {
    ...
    'index.stats.agents': 'ایجنٹ تیار',
    'index.ai.label': 'AI-Ready',
    'index.ai.heading': 'پرانا ورک فلو ختم ہو گیا۔<br>ایجنٹس پرائمٹیوز پر بناتے ہیں۔',
    'index.ai.body': 'ڈیزائنرز پکسلز دھکیلتے اور ڈویلپرز ہاتھ سے CSS لکھتے — وہ پچھلا دور تھا۔ اگلا دور یہ ہے کہ آپ پروڈکٹ بیان کریں — اور AI ایک ایسے ڈیزائن سسٹم سے انٹرفیس تیار کرے جو وہ واقعی پڑھ سکے۔ رکن اسی کے لیے بنا ہے: معنوی ٹوکنز، دستاویزی اجزاء، کوئی چھپی جادوگری نہیں۔',
    'index.ai.step1.status': 'مرحلہ 1',
    'index.ai.step1.title': 'بیان کریں',
    'index.ai.step1.body': 'اپنے ایجنٹ کو بتائیں آپ کیا بنا رہے ہیں — انگریزی، عربی، یا اردو میں۔ چیک آؤٹ فلو، ایڈمن پینل، لینڈنگ صفحہ۔ Figma فائل کی ضرورت نہیں۔',
    'index.ai.step2.status': 'مرحلہ 2',
    'index.ai.step2.title': 'ترکیب کریں',
    'index.ai.step2.body': 'ایجنٹ رکن کے ٹوکنز، کلاس نام، اور ویب کمپوننٹس پڑھتا ہے — پھر پروڈکشن مارک اپ تیار کرتا ہے۔ <code>btn-primary</code>، <code>ds-card</code>، <code>rukn-navbar</code>۔ متوقع۔ کاپی پیسٹ۔ درست۔',
    'index.ai.step3.status': 'مرحلہ 3',
    'index.ai.step3.title': 'شپ کریں',
    'index.ai.step3.body': 'آپ جائزہ لیں، بہتر بنائیں، اور تعینات کریں۔ پرائمٹیوز پر تعمیر کریں — ٹوکنز بڑھائیں، اجزاء لپیٹیں، اسٹیک کا مالک بنیں۔ MIT لائسنس۔ صفر انحصارات۔',
    'index.why.label': 'رکن کیوں',
    'index.why.heading': 'پرائمٹیوز جو ایجنٹس سمجھتے ہیں۔<br>انٹرفیس جو انسان پسند کرتے ہیں۔',
    'index.why.ai.title': 'AI-Ready آرکیٹیکچر',
    'index.why.ai.body': 'منظم دستاویزات، معنوی ٹوکنز، اور مستقل APIs — تاکہ Cursor، Claude، Copilot، اور کوئی بھی ایجنٹ سسٹم پڑھ کر پہلی بار درست UI بنا سکے۔',
    'index.why.glass.title': 'گلاس مورفزم',
    'index.why.glass.body': 'فروسٹڈ گلاس سطحیں اور شفاف گہرائی — تیار شاندار UI، ایجنٹ سے کوئی حسبِ ضرورت CSS نہیں۔',
    'index.why.tokens.title': '150+ ٹوکنز',
    'index.why.tokens.body': 'W3C کے مطابق ڈیزائن ٹوکنز — رنگ، اسپیسنگ، ٹائپوگرافی، شیڈو، اور موشن۔',
    'index.why.rtl.title': 'RTL پہلے',
    'index.why.rtl.body': 'عربی اور اردو لے آؤٹ جو بس کام کرتے ہیں۔ <code>dir="rtl"</code> سب کچھ پلٹ دیتا ہے — کوئی پیچ نہیں۔',
    'index.why.theme.title': 'ڈارک اور لائٹ',
    'index.why.theme.body': 'ایک کلاس سے تھیم بدلیں۔ ٹوکنز خود بخود ڈھلتے ہیں۔',
    'index.components.label': 'اجزاء',
    'index.components.heading': 'پرائمٹیوز جو آپ کا ایجنٹ<br>کاپی کر کے شپ کرے۔',
    'index.components.buttons.title': 'بٹنز',
    'index.components.buttons.body': 'سات اقسام، تین سائز، لوڈنگ اسٹیٹس، اور آئیکن سپورٹ۔ قابلِ رسائی فوکس رنگ شامل۔',
    'index.components.forms.title': 'فارم کنٹرولز',
    'index.components.forms.body': 'ان پٹس، چیک باکسز، ریڈیو بٹنز، ٹوگلز، سلائیڈرز — سب گلاس مورفزم اور ہموار اینیمیشنز کے ساتھ۔',
    'index.components.cards.title': 'کارڈز اور بیجز',
    'index.components.cards.body': 'سطح کے اجزاء ہاور اسٹیٹس، گلاس اقسام، اور اسٹیٹس کے لیے معنوی بیج رنگوں کے ساتھ۔',
    'index.components.viewDocs': 'دستاویزات دیکھیں',
    'index.components.viewAll': 'تمام اجزاء دیکھیں',
    'index.demo.primary': 'پرائمری',
    'index.demo.secondary': 'سیکنڈری',
    'index.demo.outline': 'آؤٹ لائن',
    'index.demo.ghost': 'گھوسٹ',
    'index.demo.delete': 'حذف',
    'index.demo.email': 'ای میل ایڈریس',
    'index.demo.checkbox': 'چیک باکس',
    'index.demo.toggle': 'ٹوگل',
    'index.demo.glassCard.title': 'گلاس کارڈ',
    'index.demo.glassCard.body': 'خوبصورت سطح کا جزو ہلکی گہرائی کے ساتھ۔',
    'index.demo.success': 'کامیابی',
    'index.demo.warning': 'انتباہ',
    'index.demo.neutral': 'غیر جانبدار',
    'index.install.label': 'ایجنٹس اور انسانوں کے لیے',
    'index.install.heading': 'اپنی AI یہاں بھیجیں۔<br>رکن پر بنائیں۔',
    'index.install.body': 'اپنے <code style="font-size:0.85em; color:hsl(var(--primary));">&lt;head&gt;</code> میں دو ٹیگز ڈالیں، ایجنٹ کو اس ریپو کی طرف بھیجیں، اور بتائیں کیا چاہیے۔ ٹوکنز، اجزاء، اور دستاویزات مشین پڑھنے والی ترکیب — اور انسانی جائزے — کے لیے منظم ہیں۔',
    'index.install.cssSize': '156 KB CSS',
    'index.install.jsSize': '82 KB JS',
    'index.install.zeroDeps': 'صفر انحصارات',
    'index.install.explore': 'اجزاء دیکھیں',
    'index.install.tokens': 'ڈیزائن ٹوکنز',
    'index.install.agentGuide': 'ایجنٹ گائیڈ (DESIGN.md)',
    ...
    'index.roadmap.label': 'روڈ میپ',
    'index.roadmap.heading': 'آگے کیا ہے۔',
    'index.roadmap.shipped': 'شپ ہو چکا',
    'index.roadmap.progress': 'جاری',
    'index.roadmap.planned': 'منصوبہ بند',
    'index.roadmap.shipped.glass': 'گلاس مورفزم سسٹم',
    'index.roadmap.shipped.tokens': '150+ ڈیزائن ٹوکنز',
    'index.roadmap.shipped.webcomponents': 'ویب کمپوننٹس لائبریری',
    'index.roadmap.shipped.motion': 'رکن موشن ایزنگ',
    ...
    'index.roadmap.progress.vscode': 'VS Code ایکسٹینشن',
    'index.roadmap.planned.mcp': 'اجزاء کی تلاش کے لیے MCP سرور',
    'index.roadmap.planned.tailwind': 'Tailwind CSS پلگ اِن',
    'index.roadmap.planned.cli': 'CLI اسکیفولڈنگ ٹول',
    'index.roadmap.planned.viz': 'ڈیٹا ویژولائزیشن',
    'index.roadmap.planned.themes': 'کمیونٹی تھیمز',
    'index.about.label': 'اوپن سورس',
    'index.about.heading': 'ہمیشہ مفت۔<br>کوئی قید نہیں۔',
    'index.about.body': '<strong style="color:hsl(var(--foreground)/0.8);">رکن</strong> <span class="arabic-text" style="color:hsl(var(--primary));">رُكن</span> عربی میں "ستون" کا مطلب ہے — وہ بنیاد جس پر AI ایجنٹس اور ڈویلپرز تعمیر کرتے ہیں۔ منظم پرائمٹیوز، MIT لائسنس، تجارتی استعمال کے لیے مفت۔',
    'index.about.mit.title': 'MIT لائسنس',
    'index.about.mit.body': 'تجارتی استعمال کریں۔ آزادانہ ترمیم کریں۔ انتساب درکار نہیں۔',
    'index.about.ai.title': 'AI-Ready',
    'index.about.ai.body': 'منظم پرائمٹیوز جو ایجنٹس پڑھتے ہیں۔ انسان جائزہ لے کر شپ کرتے ہیں۔',
    'index.about.privacy.title': 'کوئی ٹریکنگ نہیں',
    'index.about.privacy.body': 'کوئی اینالیٹکس نہیں، کوئی ٹیلیمیٹری نہیں، کوئی پے والز نہیں۔ کبھی نہیں۔',
    'index.about.star': 'GitHub پر ستارہ دیں',
    'index.about.discussions': 'بحث',
    'index.about.connect': 'رابطہ',
    'index.cta.heading': 'بیان کریں۔<br>شپ کریں۔',
    'index.cta.body': 'اپنی AI سے بات کریں۔ رکن پرائمٹیوز پر بنائیں۔ RTL، گلاس مورفزم، اور 20+ اجزاء — جب آپ تیار ہوں۔',
    'index.cta.explore': 'اجزاء دیکھیں',
    'index.cta.github': 'GitHub پر دیکھیں',
    'index.cta.meta': 'MIT لائسنس · صفر انحصارات · ہمیشہ اوپن سورس',
...
class RuknNavbar extends HTMLElement {
  ...
  _applyTranslations(language) {
    ...
    if (typeof lucide !== 'undefined') {
      lucide.createIcons({ attrs: { 'stroke-width': 1 } });
    }
  }
